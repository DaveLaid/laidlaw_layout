...
<title>Laidlaw Layout - Contact</title>
<!-- InstanceEndEditable -->

<!-- InstanceBeginEditable name="head" -->
<link href="stylesheets/contact_form.css" rel="stylesheet" type="text/css" />
...
<br />
    ...
    <label>Requests
        <!--<span class="small">Type Your Request</span>-->
    </label>
&nbsp;&nbsp;
...
<!--<form name="contactform" class="contact_form" method="post" action="contact_success.php">
  <table width="434" height="351">
  <td width="142"></td>
  </tr>
  <tr>
    <td align="right" valign="top"><label for="first_name">First Name &nbsp;</label></td>
    <td width="280" valign="top"><input  type="text" name="first_name" maxlength="50" size="35" /></td>
  </tr>
  <tr>
    <td align="right" valign="top"><label for="last_name">Last Name &nbsp;</label></td>
  ...
  <tr>
    <td align="right" valign="top"><label for="telephone">Telephone &nbsp;</label></td>
    <td valign="top"><input  type="text" name="telephone" maxlength="30" size="35" /></td>
  </tr>
  <tr>
    <td width="4" align="right" valign="top"><label for="comments">Comments &nbsp;</label></td>
    <td valign="top"><textarea  name="comments" maxlength="1000" cols="25" rows="7"></textarea></td>
  </tr>
  <tr>
    <td valign="top"><label for="blank_space">&nbsp;</label></td>
